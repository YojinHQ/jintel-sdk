// Browser-based PKCE flow against the Claude Code OAuth client. The
// CLIENT_ID matches the public Claude CLI's client_id; this benchmark is a
// trusted-developer tool, not a redistributable end-user product. Prefer
// ANTHROPIC_API_KEY in CI / unattended runs.
